...
### **Phase 1: 基本認証（優先度: 高）**
- [ ] **Day 1**: データベースマイグレーション（adminカラム追加）
- [ ] **Day 1**: Userモデルの更新（admin?メソッド追加）
- [ ] **Day 2**: Admin::BaseControllerの作成
- [ ] **Day 2**: 既存管理者コントローラーの修正
- [ ] **Day 3**: テスト・動作確認

### **Phase 2: UI改善（優先度: 中）**
- [ ] **Day 4**: 管理者ダッシュボードの作成
- [ ] **Day 4**: 管理者専用ナビゲーションの追加
- [ ] **Day 5**: 管理者ページのスタイリング改善
- [ ] **Day 5**: レスポンシブ対応
